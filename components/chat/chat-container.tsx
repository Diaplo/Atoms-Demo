...
const EXAMPLE_PROMPTS = [
  {
    title: "键盘贪吃蛇",
    prompt: "生成一个用键盘操控的贪吃蛇游戏，包含分数显示、暂停功能和重新开始按钮。",
  },
  {
    title: "任务看板",
    prompt: "做一个现代化的任务管理看板，支持待办、进行中、已完成三列，并带有卡片拖拽感的视觉效果。",
  },
  {
    title: "数据仪表盘",
    prompt: "生成一个 SaaS 数据仪表盘首页，包含 KPI 卡片、折线图区域、最近活动列表和响应式布局。",
  },
  {
    title: "产品落地页",
    prompt: "设计一个有高级感的产品落地页，包含 hero、功能介绍、用户评价和 pricing 区块，适配移动端。",
  },
] as const
